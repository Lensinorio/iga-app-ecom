package net.houssam.orderservice;

import net.houssam.orderservice.entities.Order;
import net.houssam.orderservice.entities.OrderState;
import net.houssam.orderservice.entities.ProductItem;
import net.houssam.orderservice.model.Product;
import net.houssam.orderservice.repositories.OrderRepository;
import net.houssam.orderservice.repositories.ProductItemRepository;
